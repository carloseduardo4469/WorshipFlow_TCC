...
function Brand() { return <Link href="/dashboard" className="flex items-center gap-3 px-1"><div className="relative h-12 w-12 shrink-0 overflow-hidden rounded-full ring-1 ring-cyan-300/20"><Image src={logo} alt="WorshipFlow" fill sizes="48px" className="object-cover" priority /></div><div><p className="db-brand-title db-title whitespace-nowrap text-[25px] leading-none">WorshipFlow</p><p className="db-brand-subtitle db-label mt-1.5 !text-[8px] !tracking-[0.28em]">Ministério de louvor</p></div></Link>; }
