...
export function SiteFooter() {
  ...
  return (
    <footer className={`site-footer relative border-t border-white/10 bg-[#07101e] px-5 py-6 text-[#aeb8ca] ${dentroDoDashboard ? "site-footer-dashboard z-0 pb-[calc(.75rem+70px+env(safe-area-inset-bottom))] lg:ml-[278px] lg:pb-6" : "z-20"}`}>
