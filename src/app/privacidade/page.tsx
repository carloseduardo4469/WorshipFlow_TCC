  ...
  return (
    <LegalShell>
      ...
      <div className="legal-content">
        <section className="legal-card"><span className="legal-card-icon"><Database size={19} /></span><div><h2>Dados armazenados</h2><p>Guardamos nome, e-mail, telefone opcional, foto de perfil, habilidades musicais e informações necessárias para organizar escalas e repertórios.</p></div></section>
